...
# konversi kolom order_date ke NumPy array untuk menghindari error multi-dimensional indexing
dates = daily_orders_df["order_date"].values
order_counts = daily_orders_df["order_count"].values
...
#ax.set_ylabel("Jumlah Pesanan", fontsize=16)
